...
public class LuaAsyncTask extends AsyncTask implements LuaGcable {
	...
	public LuaAsyncTask(LuaContext<Context> luaContext, long delay, LuaObject callback) throws LuaException {
	...
	public LuaAsyncTask(LuaContext<Context> luaContext, String src, LuaObject callback) throws LuaException {
		luaContext.regGc(this);
		mLuaContext = luaContext;
	...
	public LuaAsyncTask(LuaContext<Context> luaContext, LuaObject func, LuaObject callback) throws LuaException {
		luaContext.regGc(this);
		mLuaContext = luaContext;
		mBuffer = func.dump();
		mCallback = callback;
	...
	public LuaAsyncTask(LuaContext<Context> luaContext, LuaObject func, LuaObject update, LuaObject callback) throws LuaException {
		luaContext.regGc(this);
		mLuaContext = luaContext;
		mBuffer = func.dump();
		mUpdate = update;
