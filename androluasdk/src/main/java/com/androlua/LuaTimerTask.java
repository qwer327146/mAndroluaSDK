...
public class LuaTimerTask extends TimerTaskX
{
	...
	public LuaTimerTask(LuaContext<Context> luaContext, String src) throws LuaException
	{
		this(luaContext, src, null);
	}

	public LuaTimerTask(LuaContext<Context> luaContext, String src, Object[] arg) throws LuaException
	{
	...
	public LuaTimerTask(LuaContext<Context> luaContext, LuaObject func) throws LuaException
	{
		this(luaContext, func, null);
	}

	public LuaTimerTask(LuaContext<Context> luaContext, LuaObject func, Object[] arg) throws LuaException
	{
