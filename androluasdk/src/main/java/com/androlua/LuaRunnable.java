...
public class LuaRunnable extends Thread implements Runnable,LuaMetaTable,LuaGcable {
	...
	private LuaContext<Context> mLuaContext;
	...
	public LuaRunnable(LuaContext<Context> luaContext, String src) throws LuaException {
		this(luaContext, src, false, null);
	}

	public LuaRunnable(LuaContext<Context> luaContext, String src, Object[] arg) throws LuaException {
		this(luaContext, src, false, arg);
	}

	public LuaRunnable(LuaContext<Context> luaContext, String src, boolean isLoop) throws LuaException {
		this(luaContext, src, isLoop, null);
	}

	public LuaRunnable(LuaContext<Context> luaContext, String src, boolean isLoop, Object[] arg) throws LuaException {
	...
	public LuaRunnable(LuaContext<Context> luaContext, LuaObject func) throws LuaException {
		this(luaContext, func, false, null);
	}
	public LuaRunnable(LuaContext<Context> luaContext, LuaObject func, Object[] arg) throws LuaException {
		this(luaContext, func, false, arg);
	}
	public LuaRunnable(LuaContext<Context> luaContext, LuaObject func, boolean isLoop) throws LuaException {
		this(luaContext, func, isLoop, null);
	}

	public LuaRunnable(LuaContext<Context> luaContext, LuaObject func, boolean isLoop, Object[] arg) throws LuaException {
		mLuaContext = luaContext;
		if (arg != null)
			mArg = arg;
		mIsLoop = isLoop;
