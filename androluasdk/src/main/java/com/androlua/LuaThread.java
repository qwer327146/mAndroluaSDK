...
public class LuaThread extends Thread implements Runnable,LuaMetaTable,LuaGcable {
	...
	public LuaThread(LuaContext<Context> luaContext, String src) throws LuaException {
		this(luaContext, src, false, null);
	}

	public LuaThread(LuaContext<Context> luaContext, String src, Object[] arg) throws LuaException {
		this(luaContext, src, false, arg);
	}

	public LuaThread(LuaContext<Context> luaContext, String src, boolean isLoop) throws LuaException {
		this(luaContext, src, isLoop, null);
	}

	public LuaThread(LuaContext<Context> luaContext, String src, boolean isLoop, Object[] arg) throws LuaException {
	...
	public LuaThread(LuaContext<Context> luaContext, LuaObject func) throws LuaException {
		this(luaContext, func, false, null);
	}
	public LuaThread(LuaContext<Context> luaContext, LuaObject func, Object[] arg) throws LuaException {
		this(luaContext, func, false, arg);
	}
	public LuaThread(LuaContext<Context> luaContext, LuaObject func, boolean isLoop) throws LuaException {
		this(luaContext, func, isLoop, null);
	}

	public LuaThread(LuaContext<Context> luaContext, LuaObject func, boolean isLoop, Object[] arg) throws LuaException {
		mLuaContext = luaContext;
		if (arg != null)
			mArg = arg;
		mIsLoop = isLoop;
