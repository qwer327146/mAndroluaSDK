...
public class LuaArrayAdapter extends ArrayAdapter {
	...
	public LuaArrayAdapter(LuaContext<Context> context, LuaObject resource) throws LuaException {
		this(context, resource, new String[0]);
	}

	public LuaArrayAdapter(LuaContext<Context> context, LuaObject resource, Object[] objects) throws LuaException {
